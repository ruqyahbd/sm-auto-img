...
if (!class_exists('Vintage_Social_Preview')) {
    class Vintage_Social_Preview
    {
        ...
        private function generate_vsp_image($post_id)
        {
            ...
            // Font settings
            $font_size = 52; // Slightly larger for SutonnyMJ
            $angle = 0;
            ...
            // Vertical start position (centered block)
            $current_y = ($img_height - $total_height) / 2 + $font_size;
...
// Initialize the plugin    new Vintage_Social_Preview();
}
